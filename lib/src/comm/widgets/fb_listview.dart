        ...
        builder: (context, dragAnimation, inDrag) {
          ...
          return transitionBuilder(
            Column(
              ...
              children: <Widget>[
                tile,
                 Divider(height: 10, color: Color(0xFFEFEFF4).withOpacity(0),),
              ],
            ),
          );
        },
  ...
  Widget _buildTile(double t, E item, int index) {
    ...
    return Slidable(
      ...
      child: Card(
        ...
        //   //   ),
        //   // ),
        //   title: createTitle == null ? null :
        //       Column(children: [createTitle(context, item, index), Divider(height: 10,color: Colors.grey,)],)
        //
        //   ,
        //   subtitle: createSubTitle == null
        //       ? null
        //       : createSubTitle(context, item, index),
